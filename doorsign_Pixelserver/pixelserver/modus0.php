...
$name_text 			= $configContentJsonObject->{'name'};
...
$tag1_x			 	= intval($xml->template[$template]->tag1_x); 
$tag1_y			 	= intval($xml->template[$template]->tag1_y); 
$tag1_text_font		= (string)$xml->template[$template]->tag1_text_font; 
$tag1_text_height	= intval($xml->template[$template]->tag1_text_height); 
$tag1_text_wrap		= intval($xml->template[$template]->tag1_text_wrap); 
...
// define underline imagegettfttext_centered_underlined				//centered!!!! - Function
$ydistance_centered = 5;						
$xdistanceLR_centered=8;			// think 0 is fine
$yheightlineLR_centered=10;
$centerCorrecter_centered=0;

// define underline imagegettfttext_xy_underlined				// XY!!! - Function
$ydistance_xy=2;
$xdistanceLR_xy=0;
$yheightlineLR_xy=0;
...
//)save picture to MAC - data folder!	
 $path = "./data/" . $foldername;
$file = $path . "/modus0.png";	
 imagepng ( $img, $file , 0);					//saves Image to Server in specific data folder

// $modus0png = $path . "/modus0.png"; 
 // $img->render($modus0png);
