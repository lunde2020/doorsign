...
// show PHP-Header
$php_header	= 0;				
					// 0->"don't show"		==>	choose this for operation mode!			
					// 1->"show-Debug" 		==>	show picture in Browser 						
...
// Load XML file
$xml		= simplexml_load_file("./data/config.xml") or die("Error: Cannot create object");
...
$tag1_text="bin gerade leider im Urlaub =)";
$tag1_text_font='./fonts/BRADHITC.TTF';
$tag1_text_height=23;
$tag1_text_wrap=20;
...
$tag2_text="Informatik, Softwaretechnik, Angewandte Mathematik";
