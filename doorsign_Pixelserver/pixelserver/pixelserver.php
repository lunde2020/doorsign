...
// $mac="18:fe:34:d6:1c:7e"; MAC Adresse von -1.31V Display microC
...
// $configContentJsonString = file_get_contents('data.txt', true);
...
$path = "./data/" . $foldername;
$file = $path . "/modus0.jpg";	
imagejpeg ( $img, $file , 100);					//saves Image to Server in specific data folder
